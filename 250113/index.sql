...
INSERT INTO member_02 VALUES (100006,'차공단','010-1111-7777','제주도 제주시 감나무골','20151211','C','60');
...
INSERT INTO money_02 VALUES (100004,20160007,500,2,1000,'A001','20160104');
INSERT INTO money_02 VALUES (100004,20160008,300,1,300,'A005','20160104');
INSERT INTO money_02 VALUES (100004,20160009,600,1,600,'A006','20160104');
INSERT INTO money_02 VALUES (100004,20160010,3000,1,3000,'A007','20160106');

///
select * from member_02;

select r.custno, r.custname, COUNT(m.custno), SUM(m.amount), SUM(m.price) 
from member_02 r LEFT JOIN money_02 m ON r.custno=m.custno 
GROUP By r.custno, r.custname;